...
class R2RNavBatch(object):
    ''' Implements the R2R navigation task, using discretized viewpoints and pretrained features '''

    def __init__(
        self, view_db, instr_data, connectivity_dir, 
        batch_size=64, angle_feat_size=4, seed=0, name=None, sel_data_idxs=None, imagine_feat_dict = None, imagine_v2_generated_flag_dict = None, sub_instr_seg_dict = None, tokenizer = None
    ):
        ...
        self.scan_instr_id_associated = {data_dict['instr_id']:data_dict['scan'] for data_dict in self.data}
        ...
        if self.sub_instr_seg_dict is not None:

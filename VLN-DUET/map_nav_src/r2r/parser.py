...
def parse_args():
    ...
    parser.add_argument('--bypass_imag_encoder', action='store_true', default=False)
    ...
    parser.add_argument('--no_loss_test', action='store_true', default=False)
    parser.add_argument("--cosine_weight", type=float, default=0.50)
    parser.add_argument('--use_cosine_aux_loss', action='store_true', default=False)
    parser.add_argument('--aux_loss_type', default='cosine', choices=['cosine', 'contrastive-InfoNCE'])
    ...
    parser.add_argument('--imagine_features_type', default='off-the-shelf-vit', choices=['hamt-vit','off-the-shelf-vit'])
...
def postprocess_args(args):
    ...
    # path to root folder containing imagination feature files.
    HAMT_ROOTDIR='/root/lab/VLN-Imagine/VLN-HAMT/datasets'
    ...
    if args.imagination_data_v2:
        ...
        if args.imagine_features_type == 'off-the-shelf-vit':
            ...
            args.imagination_train_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-off-the-shelf-imagination-features-v2', ft_file_map[args.imag_train_features])
            args.imagination_val_seen_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-off-the-shelf-imagination-features-v2', ft_file_map[args.imag_val_seen_features])
            args.imagination_val_unseen_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-off-the-shelf-imagination-features-v2', ft_file_map[args.imag_val_unseen_features])
            args.imagination_test_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-off-the-shelf-imagination-features-v2', ft_file_map[args.imag_test_features])
        
        elif args.imagine_features_type == 'hamt-vit':
            print('Reading vit-hamt v2 imagination features.')
            args.imagination_train_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-hamt-imagination-features-v2', ft_file_map[args.imag_train_features])
            args.imagination_val_seen_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-hamt-imagination-features-v2', ft_file_map[args.imag_val_seen_features])
            args.imagination_val_unseen_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-hamt-imagination-features-v2', ft_file_map[args.imag_val_unseen_features])
            args.imagination_test_ft_file = os.path.join(HAMT_ROOTDIR, 'R2R', 'features', 'vit-hamt-imagination-features-v2', ft_file_map[args.imag_test_features])
    ...
    args.sub_instr_seg_dir = os.path.join(HAMT_ROOTDIR, 'R2R', 'annotations', 'FGR2R_nounphrase_segmentations')

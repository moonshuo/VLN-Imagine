...
class ImaginationImageFeaturesDB(object):
    ...
    def get_image_feature(self, path_obj_id_instr_idx):
        # key = '%s_%s' % (path_id, obj_id, instr_idx) #instr_idx is 0, 1 or 2.
        key = path_obj_id_instr_idx #This should be a string.
        if key in self._feature_store:

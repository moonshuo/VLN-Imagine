...
class Seq2SeqAgent(BaseAgent):
    ...
    def __init__(self, args, env, rank=0):
        ...
        if self.args.imagine_enc_pano and self.args.use_cosine_aux_loss:
            self.cosine_loss_weight = self.args.cosine_weight

        if self.args.imagine_enc_pano and self.args.experimental_warmup and (self.args.experimental_warmup_type == 'variant4'):
